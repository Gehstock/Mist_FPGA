...
set_multicycle_path -from {ScooterShooter:ScooterShooter_inst|mc6809is:u12A|*} -setup 2
set_multicycle_path -from {ScooterShooter:ScooterShooter_inst|mc6809is:u12A|*} -hold 1
